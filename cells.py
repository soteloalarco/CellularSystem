...
class Simulacion(object):
    ...
    def simulacionEventosDiscretos(entorno, usuario, simulacion, terminarSimulacion):
        ...
        hex = RegularPolygon((0, 0), numVertices=6, radius=r_cell_plot, orientation=np.radians(30), facecolor="blue", alpha=0.2,
                             edgecolor='k')
        ax.add_patch(hex) # se dibuja el exagono
        ...
        for j in range(0, len(aux1)):
            ...
            hex = RegularPolygon((bs_position[j][0], bs_position[j][1]), numVertices=6, radius=r_cell_plot,
        ...
        for j in range(0, len(aux1)):
            ...
            hex = RegularPolygon((bs_position[j][0] / 2, bs_position[j][1] / 2), numVertices=6, radius=r_cell_plot,
